...
# NOTE: Code unmodified - Downloaded June 26, 2015 - John Debs
...
suggest_next_steps() {
    ...
    if [ "$PREREQ_LIST" ]; then
        ...
        echo_banner "    http://support.tv.appneta.com/support/solutions/articles/86353-installation-overview" nosleep
        echo_banner ""
    fi
}
...
onError() {
    ...
    echo_banner "Please contact traceviewsupport@appneta.com or visit http://support.tv.appneta.com for assistance." nosleep
